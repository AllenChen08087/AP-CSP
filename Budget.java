...
public class Budget{
    ...
    //procedure: check if the spending will exceed the budget, and return true or false based on the budget left and the spending
    ...
    //ask users to input their spendins until either the spendings exceed the budget or the users stop the inputs manually
    while (end == false){        
        ...
        if (exceedBudget(budget_left, purchase)){
            System.out.println("This spending has exceed your budget");
        }
        else{
